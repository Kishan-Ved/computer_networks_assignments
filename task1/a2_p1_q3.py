...
PCAP_FILE_CLIENT = "p1_q3_client_scalable_h1.pcap"
PCAP_FILE_CLIENT2 = "p1_q3_client_scalable_h3.pcap"
PCAP_FILE_CLIENT3 = "p1_q3_client_scalable_h4.pcap"
PCAP_FILE_SERVER = "p1_q3_server_scalable.pcap"
...
def runExperiment(net, ccs):
    ...
    client_cmd_h3 = f"iperf3 -c {h7.IP()} -p 5201 -b 10M -P 10 -t 15 -C {ccs} -V &"
    h3.cmd(client_cmd_h3)
    
    time.sleep(20)  # Allow test to complete
    
    print("\n*** Stopping tcpdump on H3 and H7")
